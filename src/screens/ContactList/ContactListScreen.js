...
const ContactListScreen = ({ navigation }) => {
  const { contacts, toggleFavorite, refreshContacts } = useContacts();
  ...
  const renderContactItem = useCallback(
    ({ item }) => (
      <ContactListItem
        ...
        onEditPress={handleEditPress} // Pass the new prop
      />
    ),
    [handleContactPress, handleFavoritePress, handleCallPress, handleMessagePress, handleEditPress]
  );
